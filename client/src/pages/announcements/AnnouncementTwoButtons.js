...
const AnnouncementTwoButtons = props => {
  ...
  return (
    <>
      <TwoStateButtonWrapper disabled={disabled} firstButton={firstButton} secondButton={secondButton} useFirstState={useFirstState} wrapperClass='AnnouncementStrip__btn-div' />
    </>
  );
}
